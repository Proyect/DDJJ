    ...
    <form action="{{ $funcionario->id ? route('funcionario.update', $funcionario) : route('funcionario.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input type="radio"  id="genero" name="genero" value="Femenino{{-- {{ old('genero', optional($funcionario)->genero) }} --}}" chequed>
                        Masculino<br>
          ...
          {{-- <div class="mb-3 row"> --}}
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">                   
                    <textarea class="form-control" id="observacionesF" name="observacionesF" rows="10" cols="50" required>{{ old('observacionesF', optional($funcionario)->observacionesF) }}
                    </textarea>
                </div>
